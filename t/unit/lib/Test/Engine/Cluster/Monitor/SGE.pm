...
#### NB: EXTEND Engine::Cluster::Monitor::SGE IN ORDER TO PROVIDE DUMMY FUNCTIONS

class Test::Engine::Cluster::Monitor::SGE extends Engine::Cluster::Monitor::SGE with (Test::Common) {
#with (Test::Common, Table::Main,  Web::Cloud::Cluster, Table::Common, Util::Main) {
...
method testRemainingJobs {
	...
	ok( $self->identicalArray($statushash, $expected), "testRemainingJobs    statushash is as expected");
}
...
}   #### Test::Engine::Cluster::Monitor::SGE